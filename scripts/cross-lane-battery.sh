...
# development subscription, and every lane drives a real hgtran-ai binary
# end to end against live scratch repositories.
#
# Usage:
#   scripts/cross-lane-battery.sh --binary /path/to/hgtran-ai [--with-model] [--with-host] [--keep-work]
#
...
#   host-pi       - the INSTALLED hgtran-pi review-host-relay code runs a real
