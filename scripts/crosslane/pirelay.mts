...
// INSTALLED hgtran-pi review-host-relay implementation: the lib/ sources are
...
// exactly as hgtran-pi's status decoder does; both the current `value` object
...
//     "gentle_ai_executable": "/abs/path/hgtran-ai",
//     "pi_executable": "pi"
//   }
...
const result = await runReviewHostRelaySlot({
  ...
  environment: { ...process.env, GENTLE_PI_REVIEW_RELAY_CONTRACT: "hgtran-pi.review-relay/v1" },
})
