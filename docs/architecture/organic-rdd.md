...
`hgtran-ai review mode enable --scope global`, it does not govern the candidate.
Nothing blocks or gates delivery; ordinary repository policy applies. `hgtran-ai
