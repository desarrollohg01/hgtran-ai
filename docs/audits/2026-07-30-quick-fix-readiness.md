...
| [#828](https://github.com/Gentleman-Programming/gentle-ai/issues/828) | Open; owning-track work | Systemic-contract-failure | Hgtran AI catalog identity conflicts with external Engram vocabulary. |
