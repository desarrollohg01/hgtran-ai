...
|---|---|---|
| `cmd/hgtran-ai/` | Binary entrypoint and version handoff. | Business rules or file mutation logic. |
...
| `internal/state/` | `~/.hgtran-ai/state.json` persisted install selections. | Engram memory state. |
