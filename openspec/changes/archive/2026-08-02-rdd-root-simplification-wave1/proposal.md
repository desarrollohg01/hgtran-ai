...
Wave-1 `absorbed-into-wave-1` backlog (17): hgtran-ai #1234, #1453, #1523, #1530, #1531, #1532, #1563, #1590, #1736, #1740, #1758, #1762, #2160, #2169; hgtran-pi #194, #197, #204. Wave 1 measures, it does not close them.
...
4. **hgtran-pi scope**: must the resolver cover Pi protocol-1.1 overlay selectors now (pi#194/#197/#204 are absorbed here)? *Assumption: hgtran-ai selectors only; Pi is covered by the same algebra at the consumer wave.*
