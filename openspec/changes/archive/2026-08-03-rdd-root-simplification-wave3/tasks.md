...
- [x] 4.5 Modify `review_facade.go`:1618 start branch: `HGTRAN_AI_RDD_NEW_LINEAGE` OFF (default) → legacy `NewCompactState`; ON → `ReviewCore.Next`/`AuthorityStore.Create`.
