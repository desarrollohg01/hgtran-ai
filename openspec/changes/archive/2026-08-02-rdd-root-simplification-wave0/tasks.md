...
- [x] 2.9 Correct the `Evidence and scope` "Prior system audit" row path from the external `/home/hgtran/work/rdd-system-audit.md` to `docs/audits/2026-07-21-rdd-system-audit.md`. Req: Design Document Source and Evidence Paths.
