...
**Worktree**: /home/hgtran/work/hgtran-ai-worktrees/rdd-wave6 @ e174bc2b on feat/rdd-wave6-f2-journey-positions (clean)
...
$ go build -tags bench_fixture ./cmd/hgtran-ai # exit 0
...
```text
PLAIN  go build ./cmd/hgtran-ai      -> 82 completed, 7 unsupported, 0 failed
...
VH_C3_CONTINUATION exit=1
  Error: review transaction changed concurrently: submitted plan_digest/inventory_revision
         does not match the current provider-derived plan; run `hgtran-ai review repair
...
VH_C3_FRESH_DRIFT err=review transaction changed concurrently: submitted
  ...
  run `hgtran-ai review repair --preflight` again for the current values
