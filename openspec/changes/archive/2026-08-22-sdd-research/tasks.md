...
- [x] 4.4 REFACTOR/VERIFY — Run focused tests, `go test ./...`, `go vet ./...`; if binary routing changes, reproduce CI’s `hgtran-ai-bench run --binary ...`. `go test ./bench` is not execution proof.
