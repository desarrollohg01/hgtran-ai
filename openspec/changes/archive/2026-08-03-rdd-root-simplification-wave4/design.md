...
| CON-10 Pi | `internal/agents/pi/adapter.go` — zero review references | hgtran-pi host repo | **Out of repo**; in-repo surface is clean. Gated by its declared capability only. |
