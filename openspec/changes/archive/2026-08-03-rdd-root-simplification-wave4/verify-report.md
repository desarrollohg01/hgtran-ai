...
**Candidate**: worktree `/home/hgtran/work/hgtran-ai-worktrees/rdd-wave4`, tip `d039d6e34de45763a906a2b93fcc33c1a3a6b063`
...
$ go test ./... -count=1
...
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/reviewtransaction	124.880s
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/sddstatus	24.201s
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/update/upgrade	7.115s
...
ok  	github.com/desarrollohg01/hgtran-ai/bench	0.178s
BENCH_EXIT=0
```
...
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/cli	0.134s

$ go test ./internal/components/ -run Golden -count=1     # no -update
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/components	0.564s
```
...
**Candidate**: worktree `/home/hgtran/work/hgtran-ai-worktrees/rdd-wave4`, tip `0a5f13b9f09f320c031ae51c9eb7974ae5ba4ff6`
...
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/cli	0.286s
...
ok  	github.com/desarrollohg01/hgtran-ai/v2/internal/reviewtransaction	0.049s
```
...
FAIL	github.com/desarrollohg01/hgtran-ai/v2/internal/sddstatus	0.007s
```

Genuine RED. **But** stripping the two *call sites* in `Resolve()`/`resolveEngramStatus()` instead leaves everything green:

```text
ok  github.com/desarrollohg01/hgtran-ai/v2/internal/sddstatus       22.237s
ok  github.com/desarrollohg01/hgtran-ai/v2/internal/cli            176.419s
ok  github.com/desarrollohg01/hgtran-ai/v2/e2e/organicruntime       13.022s
```
...
**Candidate**: worktree `/home/hgtran/work/hgtran-ai-worktrees/rdd-wave4`, tip `89c7e5fde07fabd73d28d4ac43a3a21351f02c87`
...
**Candidate**: worktree `/home/hgtran/work/hgtran-ai-worktrees/rdd-wave4`, tip `cb195782fbc3f6394536e9f3e6ba92cb25b9118e`
...
**Candidate**: worktree `/home/hgtran/work/hgtran-ai-worktrees/rdd-wave4`, tip `ea73f7cd`
**Chain base**: `git merge-base HEAD 67be4867` = `67be4867…` (unchanged).
...
```text
ok  github.com/desarrollohg01/hgtran-ai/v2/internal/agents                    0.007s
ok  github.com/desarrollohg01/hgtran-ai/v2/internal/agents/pi                 0.007s
ok  github.com/desarrollohg01/hgtran-ai/v2/internal/agents/capabilitymanifest 0.003s
```
...
**Candidate**: worktree `/home/hgtran/work/hgtran-ai-worktrees/rdd-wave4`, tip `7598eda430a6cc1fe8ab6b62cd971862ba03a786`
...
- The amendment's other two pointers both resolve correctly at HEAD:
  ...
  ok  github.com/desarrollohg01/hgtran-ai/v2/internal/agents  0.003s
  ```
