...
- Typed refusals naming concrete commands verbatim: 1812 names `hgtran-ai review start --projection staged` and `hgtran-ai review start --base-ref <ref> --committed-only` (`review_facade.go:975-977`); 1788 names `hgtran-ai review capture-evidence` then `hgtran-ai review finalize --lineage <id> --captured-evidence` with the real lineage interpolated (`:1834-1839`).
