...
The lane MUST accept only `hgtran-ai.sdd-research-capability/v1` and classes `documentation` and `open-web`; admission MUST verify declaration and exact grant. Unknown or missing values, Bash, generic MCP, and unnamed inherited tools MUST deny.
