...
const (
	...
	statusSchemaV6                             = "hgtran-ai.review-integration.status/v6"
	verificationEvidenceSchemaV1               = "https://hgtran-ai.dev/schema/review/verification-evidence/v1"
	verificationEvidenceRecordSchemaV2         = "hgtran-ai.review-verification-evidence/v2"
)
...
func executeV5CaptureEvidenceDescriptor(r *journeyRun, lineage, evidenceName string) (waveCorrectionStatus, error) {
	...
	if status.Schema != statusSchemaV6 || status.Authority == nil || status.NextTransition == nil ||
