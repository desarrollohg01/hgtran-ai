...
| `hgtran-ai-bench` | When touching `bench/`, journeys, driven mode, the journey corpus, or bench axes. | [`skills/hgtran-ai-bench/SKILL.md`](skills/hgtran-ai-bench/SKILL.md) |
