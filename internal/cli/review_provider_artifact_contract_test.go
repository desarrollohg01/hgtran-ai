...
// result (hgtran-ai.review-gate-result/v1) and the OpenCode provider-role
// capture acknowledgement (hgtran-ai.opencode-review-provider-role/v1). Both
...
func TestReviewProviderArtifactSchemasAreStrictAndBound(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "transition-execution.schema.json", id: "https://hgtran-ai.dev/contracts/review-integration/v1/schemas/transition-execution.schema.json"},
	...
	v2Schemas := []struct {
		...
		{name: "gate-result.schema.json", id: "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/gate-result.schema.json"},
		{name: "last-event-closure.schema.json", id: "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/last-event-closure.schema.json"},
		{name: "opencode-provider-role.schema.json", id: "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/opencode-provider-role.schema.json"},
	}
