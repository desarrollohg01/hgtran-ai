...
// hgtran-neutral-artifacts alias is remapped to the neutral persona.
const personaAliasRemapNotice = `"hgtran-neutral-artifacts" now maps to "neutral". For a voseo conversation use --persona hgtran.`
...
// The second return is true when the legacy hgtran-neutral-artifacts
// alias was remapped to neutral: its name promised a neutral tone, so the
// name now wins; users who want voseo have --persona hgtran.
