...
func RunReviewLegacyQuarantine(args []string, stdout io.Writer) error {
	...
	authorization := flags.String("maintainer-authorization", "", "exact eight-line LF-only binding: hgtran-ai.review-legacy-quarantine-authorization/v1, repository, lineage, revision, diagnostic, disposition, actor, reason")
