...
const (
	...
	reviewAuthorityNewerReleaseAction = "upgrade this hgtran-ai, or invoke the newer build directly; " +
		"an editor plugin resolves hgtran-ai from PATH, so run `which -a hgtran-ai` and make the newer build the one it finds first"
)
