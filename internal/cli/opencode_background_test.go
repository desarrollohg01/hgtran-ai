...
func TestPersistInstallStateFullInstallPreservesUnrelatedFields(t *testing.T) {
	...
	fresh := state.InstallState{InstalledAgents: []string{"opencode"}, SelectionConfigured: true, Components: []model.ComponentID{model.ComponentPermission}, Persona: "hgtran", BackgroundIntent: model.OpenCodeBackgroundOn}
