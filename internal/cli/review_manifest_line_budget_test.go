...
func TestEncodeReviewJSONLeavesNonManifestPayloadsByteIdentical(t *testing.T) {
	payloads := []any{
		...
		ReviewIntegrationFailure{Schema: "hgtran-ai.review-integration.failure/v2", Operation: "review.start", Code: "invalid_request"},
	}
...
func TestEncodeReviewJSONPreservesManifestValue(t *testing.T) {
	...
	}{Schema: "hgtran-ai.review-capture-preflight/v1", ChangedPathManifest: manifest, Trailing: "after"}
