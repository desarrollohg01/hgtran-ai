...
const ReviewIntegrationCapabilitiesSchemaV23 = "hgtran-ai.review-integration.capabilities/v2.3"
const ReviewIntegrationCapabilitiesSchemaIDV23 = "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/capabilities-v2.3.schema.json"
const ReviewIntegrationCapabilitiesSchemaV24 = "hgtran-ai.review-integration.capabilities/v2.4"
const ReviewIntegrationCapabilitiesSchemaIDV24 = "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/capabilities-v2.4.schema.json"
...
const reviewNextTransitionRefreshCommandV21 = "hgtran-ai review status --cwd <repo> --contract " + ReviewIntegrationContractV2 + " --next-transition"
