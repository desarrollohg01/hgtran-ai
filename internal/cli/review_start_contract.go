...
const ReviewIntegrationStartSchemaV3 = "hgtran-ai.review-integration.start/v3"
const ReviewIntegrationStartSchemaIDV3 = "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/start.schema.json"
const ReviewIntegrationStartSchemaV4 = "hgtran-ai.review-integration.start/v4"
const ReviewIntegrationStartSchemaIDV4 = "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/start-v4.schema.json"
