...
func TestV2TransitionSchemasStayLocalSharedAndPackaged(t *testing.T) {
	...
	for name, wantID := range map[string]string{
		reviewV2TransitionBindingSchema:   "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/transition-binding.schema.json",
		reviewV2TransitionExecutionSchema: "https://hgtran-ai.dev/contracts/review-integration/v2/schemas/transition-execution.schema.json",
	} {
