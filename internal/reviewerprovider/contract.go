...
const TransportCapability = "hgtran-ai.provider-transport/v1"

const (
	LensResultSchema = `{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://hgtran-ai.dev/schema/review/reviewer/v1",
  "title": "Hgtran AI reviewer result",
  "type": "object",
...
const targetedValidatorPromptInstruction = "You are the read-only targeted fix validator. " +
	...
	"`hgtran-ai review inspect-candidate --purpose targeted-validation " +
...
var contracts = []Contract{
	{
		ID: string(RoleLens), Role: RoleLens, RequestSchemaID: "hgtran-ai.review-lens-context/v1",
		ResultSchemaID: "https://hgtran-ai.dev/schema/review/reviewer/v1", ResultSchema: []byte(LensResultSchema), StorageSlot: "selected-lens",
		RequiredCapabilities: []string{TransportCapability}, ResultLimit: 4 << 20,
	},
	{
		ID: string(RoleRefuter), Role: RoleRefuter, RequestSchemaID: "hgtran-ai.review-provider-refuter-request/v1",
		ResultSchemaID: "https://hgtran-ai.dev/schema/review/refuter/v1", ResultSchema: []byte(RefuterResultSchema), StorageSlot: "transaction-refuter-batch",
		RequiredCapabilities: []string{TransportCapability}, ResultLimit: 4 << 20,
	...
	{
		ID: string(RoleTargetedValidator), Role: RoleTargetedValidator, RequestSchemaID: "hgtran-ai.review-targeted-validation-request/v1",
		ResultSchemaID: "https://hgtran-ai.dev/schema/review/validator/v1", ResultSchema: []byte(TargetedValidatorResultSchema), StorageSlot: "correction-targeted-validator",
		RequiredCapabilities: []string{TransportCapability}, ResultLimit: 4 << 20,
