...
func TestClaudeWorkflowPointersNameWorkspaceAndHomeLocations(t *testing.T) {
	for _, asset := range []string{"claude/commands/hgtran-sdd-new.md", "claude/commands/hgtran-sdd-continue.md", "claude/commands/hgtran-sdd-ff.md", "claude/sdd-orchestrator.md"} {
