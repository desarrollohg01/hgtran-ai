...
func TestManagedDirectReplyAssetsEnforceEnglishNoCodeSwitching(t *testing.T) {
	tests := []struct {
		...
		{name: "claude hgtran output style", path: "claude/output-style-hgtran.md"},
		...
		// file alone.
		{name: "claude hgtran persona", path: "claude/persona-hgtran.md", combineWith: "claude/output-style-hgtran.md"},
		{name: "generic hgtran persona", path: "generic/persona-hgtran.md"},
		{name: "generic neutral persona", path: "generic/persona-neutral.md"},
		{name: "hermes hgtran persona", path: "hermes/persona-hgtran.md"},
		{name: "hermes neutral persona", path: "hermes/persona-neutral.md"},
		{name: "kiro hgtran persona", path: "kiro/persona-hgtran.md"},
		{name: "kimi hgtran output style", path: "kimi/output-style-hgtran.md"},
		{name: "kimi neutral output style", path: "kimi/output-style-neutral.md"},
		{name: "kimi hgtran persona", path: "kimi/persona-hgtran.md", combineWith: "kimi/output-style-hgtran.md"},
		{name: "opencode hgtran persona", path: "opencode/persona-hgtran.md"},
	}
...
func TestGentlemanPersonaKeepsDirectConversationVoice(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "claude/persona-hgtran.md", combineWith: "claude/output-style-hgtran.md"},
		{path: "generic/persona-hgtran.md"},
		{path: "kiro/persona-hgtran.md"},
		{path: "kimi/persona-hgtran.md", combineWith: "kimi/output-style-hgtran.md"},
		{path: "opencode/persona-hgtran.md"},
	}
	for _, tc := range tests {
