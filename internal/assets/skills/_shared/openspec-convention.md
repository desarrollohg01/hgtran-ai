...
`research.md` contains exact `hgtran-ai.sdd-research/v1` bytes. Hybrid pre-proposal state uses `hgtran-ai.sdd-preproposal/v1`; compare its revision and bytes with Engram before readiness and never prefer one store after mismatch.
