...
- Admit only `hgtran-ai.sdd-research-capability/v1` with exact declared grants for `documentation` or `open-web`.
...
4. Persist `hgtran-ai.sdd-research/v1` and update `hgtran-ai.sdd-preproposal/v1` using the active store contract.
