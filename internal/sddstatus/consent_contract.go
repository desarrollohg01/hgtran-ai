...
// hgtran-ai.review-integration.consent/v2.
const SDDIntegrationConsentSchema = "hgtran-ai.sdd-integration.consent/v1"
...
const SDDIntegrationConsentSchemaID = "https://hgtran-ai.dev/contracts/sdd-integration/v1/schemas/consent.schema.json"

// SDDIntegrationContractV1 names the sdd-integration contract the envelope
// belongs to.
const SDDIntegrationContractV1 = "hgtran-ai.sdd-integration/v1"
...
const (
	...
	sddConsentGrantInvocationPrefix = "hgtran-ai sdd-attempt grant "
	...
	sddConsentStatusInvocationPrefix = "hgtran-ai sdd-status "
)
