...
const (
	bundleSchema             = "hgtran-ai.review-provider-contract-bundle/v1"
...
var bundleREADME = []byte(`# Hgtran AI review provider contract

This data-only bundle describes the provider result contracts admitted by Hgtran AI.
