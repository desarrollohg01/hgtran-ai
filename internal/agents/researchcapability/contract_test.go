...
func TestAdmitFailsClosedAndReturnsOnlyVerifiedGrants(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "unknown schema", request: Request{Schema: "hgtran-ai.sdd-research-capability/v2", AgentID: model.AgentClaudeCode, Class: ClassDocumentation, ObservedGrants: []Grant{GrantWebFetch}}},
