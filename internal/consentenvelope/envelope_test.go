...
func validCore() Core {
	return Core{
		...
		Evidence: []string{},
		Choices: []Choice{
			{Answer: "granted", Label: "Grant", Effect: "Grants once.", Invocation: "hgtran-ai example --consent granted"},
			{Answer: "declined", Label: "Decline", Effect: "Stays blocked.", Invocation: "hgtran-ai example --consent declined"},
		},
		OffPath: OffPath{Note: "The documented alternative.", Command: "hgtran-ai example off"},
	}
}
