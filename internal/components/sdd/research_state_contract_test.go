...
func TestHybridRestartRequiresByteEqualStateWithoutStorePreference(t *testing.T) {
	...
	contracts := map[string][]string{
		"research-lifecycle.md": {
			"hgtran-ai.sdd-preproposal/v1", "revision", "research request and classes",
		...
		"engram-convention.md":   {"sdd/{change-name}/research", "hgtran-ai.sdd-research/v1", "hgtran-ai.sdd-preproposal/v1"},
		"openspec-convention.md": {"research.md", "hgtran-ai.sdd-research/v1", "hgtran-ai.sdd-preproposal/v1"},
		"sdd-status-contract.md": {"hgtran-ai.sdd-status/v2", "pre-proposal gate", "matching hybrid state"},
	}
